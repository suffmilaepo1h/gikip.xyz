...
const START_MESSAGE = `Dont worry, gikip is good`;
...
export default function GoodConsole() {
  ...
  const submitPrompt = async () => {
    ...
    const response = await prompt(inputValue, false);
    setResponding(false);
  ...
  return (
    <div
      ref={consoleRef}
      className={classNames(style.console, style.good)}
      style={{
        left: `${position.x}px`,
        top: `${position.y}px`,
        position: "absolute",
    ...
    >
      ...
      >
        GoodGikip {responding ? "(responding)" : ""}
      </div>
